...
be arranged in a way that makes sense when reading the CSV. The final
dataset written as GBB_merged\_ and it contain the variabes series,
episode, bakers, baker_age, technical, result, baker_occupation,
...
10 since he never was crowned STAR BAKER.

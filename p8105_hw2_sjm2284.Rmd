...
write_csv(GBB_merged,"./data/GBB_new.csv")
...
Nancy and Nadiya were predictable overall winners because they were STAR BAKERS more than the other contestants. David was a surprise for winning in season 10 since he never was crowned STAR BAKER. 

...
The final dataset written as GBB_merged_ and it contain the variabes series, episode, bakers, baker_age, technical, result, baker_occupation, hometown, signature_bake, show_stopper. The total observations `r nrow(GBB_merged_)` and columns `r ncol(GBB_merged_)`
